...
if("TRUE" STREQUAL "TRUE")
  set(rosbuzz_SOURCE_PREFIX /home/jackson/Development/HARE/src/rosbuzz)
  set(rosbuzz_DEVEL_PREFIX /home/jackson/Development/HARE/devel)
  set(rosbuzz_INSTALL_PREFIX "")
  set(rosbuzz_PREFIX ${rosbuzz_DEVEL_PREFIX})
else()
  set(rosbuzz_SOURCE_PREFIX "")
  set(rosbuzz_DEVEL_PREFIX "")
  set(rosbuzz_INSTALL_PREFIX /home/jackson/Development/HARE/install)
...
if(NOT "/home/jackson/Development/HARE/devel/include;/home/jackson/Development/HARE/src/rosbuzz/include " STREQUAL " ")
  set(rosbuzz_INCLUDE_DIRS "")
  set(_include_dirs "/home/jackson/Development/HARE/devel/include;/home/jackson/Development/HARE/src/rosbuzz/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbuzz' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbuzz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jackson/Development/HARE/src/rosbuzz/${idir}'.  ${_report}")
    endif()
...
set(rosbuzz_EXPORTED_TARGETS "rosbuzz_generate_messages_cpp;rosbuzz_generate_messages_eus;rosbuzz_generate_messages_lisp;rosbuzz_generate_messages_nodejs;rosbuzz_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosbuzz_dep}_FOUND)
      find_package(${rosbuzz_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosbuzz_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
