...
\begin{abstract}
  ...
  \begin{figure}[H]
    \centering
      \includegraphics[width=0.3\textwidth]{hare-rabbit}
...
%
%
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pics/allen_spain}}]{Allen Spain}
% Lead Hardware Engineer Small Satellite Research Laboratory.
% \end{IEEEbiography}
%
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pics/caleb_adams}}]{Caleb Adams}
% I work in the small satellite research lab as a systems engineer.
% \end{IEEEbiography}
